/********************************************************************************
** Form generated from reading UI file 'MainWindowYeFXhw.ui'
**
...
#ifndef MAINWINDOWYEFXHW_H
#define MAINWINDOWYEFXHW_H
...
public:
    ...
    QAction *m_aboutLithiumBitAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/lithiumbit"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutLithiumBitAction = new QAction(MainWindow);
        m_aboutLithiumBitAction->setObjectName(QStringLiteral("m_aboutLithiumBitAction"));
        m_aboutLithiumBitAction->setEnabled(true);
        ...
        sizePolicy2.setHeightForWidth(m_toolFrame->sizePolicy().hasHeightForWidth());
        m_toolFrame->setSizePolicy(sizePolicy2);
        m_toolFrame->setMinimumSize(QSize(1080, 70));
        m_toolFrame->setFrameShape(QFrame::NoFrame);
        m_toolFrame->setFrameShadow(QFrame::Plain);
        m_toolFrame->setLineWidth(-2);
        ...
        sizePolicy3.setHeightForWidth(m_overviewButton->sizePolicy().hasHeightForWidth());
        m_overviewButton->setSizePolicy(sizePolicy3);
        m_overviewButton->setMinimumSize(QSize(179, 0));
        ...
        sizePolicy3.setHeightForWidth(m_transactionsButton->sizePolicy().hasHeightForWidth());
        m_transactionsButton->setSizePolicy(sizePolicy3);
        m_transactionsButton->setMinimumSize(QSize(180, 0));
        ...
        sizePolicy3.setHeightForWidth(m_blockExplorerButton->sizePolicy().hasHeightForWidth());
        m_blockExplorerButton->setSizePolicy(sizePolicy3);
        m_blockExplorerButton->setMinimumSize(QSize(180, 0));
        m_blockExplorerButton->setFocusPolicy(Qt::NoFocus);
        m_blockExplorerButton->setCheckable(true);

        horizontalLayout_5->addWidget(m_blockExplorerButton);
        ...
        m_sendButton->setMinimumSize(QSize(180, 0));
        ...
        sizePolicy3.setHeightForWidth(m_addressBookButton->sizePolicy().hasHeightForWidth());
        m_addressBookButton->setSizePolicy(sizePolicy3);
        m_addressBookButton->setMinimumSize(QSize(180, 0));
        ...
        sizePolicy3.setHeightForWidth(m_miningButton->sizePolicy().hasHeightForWidth());
        m_miningButton->setSizePolicy(sizePolicy3);
        m_miningButton->setMinimumSize(QSize(180, 0));
        m_miningButton->setFocusPolicy(Qt::NoFocus);
        m_miningButton->setCheckable(true);

        horizontalLayout_5->addWidget(m_miningButton);


        verticalLayout_2->addWidget(m_toolFrame);
        ...
        menuHelp->addAction(m_aboutLithiumBitAction);
        ...
        QObject::connect(m_aboutLithiumBitAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutLithiumBitAction->setText(QApplication::translate("MainWindow", "About LithiumBit", nullptr));
...
#endif // QT_NO_TOOLTIP
        m_communityForumAction->setText(QApplication::translate("MainWindow", "Pool", nullptr));
        m_reportIssueAction->setText(QApplication::translate("MainWindow", "Soporte", nullptr));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND LBIT", nullptr));
